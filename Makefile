...
INC_DIR					=	includes
INC_FILE				= 	IRC user/User user/AllClient commands/Command commands/Kick Server/Server
INC						= 	$(addsuffix .hpp, $(addprefix $(INC_DIR)/, $(INC_FILE)))

SRCS_DIR				=	srcs
SRCS_FILE				=	main user/User user/AllClient commands/Command commands/Kick Server/Server
